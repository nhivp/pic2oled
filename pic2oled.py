...
def output(data):
    ...
    output_f = open(filename + ".h", "w")
    output_f.write("/* This file is automatically generated by the pic2oled tool. */\n\n")
    output_f.write("/* Image size: Width = " + str(oledWidth) + ", Height = " + str(oledHeight) + " */\n")
